...
/*        Node testTreeWithOneLevel = getTestTree(1);
        int p1 = countPaths(testTreeWithOneLevel, 2, 0, new Stack<Node>());
        int p2 = countPaths(testTreeWithOneLevel, 1, 0, new Stack<Node>());
        System.out.println("p1 = " + p1 + " ,p2 = " + p2);
*/
        Node testTreeWithFourLevels = getTestTree(4);
        int p3 = countPaths(testTreeWithFourLevels, 0, 1, new Stack<Node>());
 //       int p4 = countPaths(testTreeWithFourLevels, 5, 0, new Stack<Node>());
